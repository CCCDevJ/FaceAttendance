...
class MainActivity : AppCompatActivity() {
    ...
    private fun processImage(imageProxy: ImageProxy) {
        ...
        if (mediaImage != null) {
            ...
            updateDebugInfo("Processing image...")
    ...
    private suspend fun processFaceDetection(face: Face, faceBitmap: Bitmap) {
        ...
        if (matchingEmployee != null) {
            ...
            if (matchingEmployee.id == lastRecognizedEmployeeId) {
                recognitionCounter++
                updateDebugInfo("Recognition count: $recognitionCounter/$REQUIRED_RECOGNITIONS")
                ...
                updateDebugInfo("New face detected: ${matchingEmployee.name}")
            }
        } else {
            if (DEBUG_MODE) {
